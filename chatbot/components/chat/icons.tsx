export const SLLLogo = ({
  size = 120,
  className,
}: { size?: number; className?: string }) => {
  const height = size * (30 / 170);
  return (
    <svg
      className={className}
      height={height}
...
export const SLLMark = ({
  size = 24,
  className,
}: { size?: number; className?: string }) => {
  // Just the parallelogram mark from the logo
  return (
    <svg
      className={className}
      height={size}
    ...
    >
      <path
        d="M22.5,2.56l-.09.19L14.58,27.44H2.83l.09-.19L10.75,2.56H22.5M24,0H9.93L.52,26.06l-.52,3.94h14.07L23.48,3.94,24,0Z"
        fill="currentColor"
      />
    </svg>
  );
